...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/WeatherProvider/NationalWeatherService-Swift.git", from: "0.4.2"),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "MeteorologicalServiceOfCanada", package: "MeteorologicalServiceOfCanada")
